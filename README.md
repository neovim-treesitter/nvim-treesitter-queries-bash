...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-bash/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-bash/actions/workflows/validate.yml)

Neovim tree-sitter queries for **bash**, part of the
...
- [ ] Changes are scoped to `bash` — do not include files for other languages
